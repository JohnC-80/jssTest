...
import resetcss from 'normalize.css/normalize.css'
import ReactDOM from 'react-dom'
import Paneset from './js/components/Paneset/Paneset'

import SearchPane from './js/components/SearchPanes/SearchPane'
    ...
    render(){
        ...
        return(
                <div style={{display: 'flex', height:'100%', width: '100%', flexDirection:'column', justifyContent:'flex-start' }}>
                  ...
                  <Paneset>
                    <SearchPane onSearch={this.onEnterSearch.bind(this)} fieldValue={this.state.searchTerm}></SearchPane>
                    {resultsPane}
                    {detailPane}
                  </Paneset>
                  </div>
